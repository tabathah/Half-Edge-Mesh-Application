...
protected:
    ...
    GLuint bufID; //VBO to store indices of the joints the vertex is influenced by
    GLuint bufWeight; //VBO to store weights of the joints the vertex is influenced by
