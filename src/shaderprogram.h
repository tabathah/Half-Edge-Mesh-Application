...
public:
    ...
    int unifBindMats; //handle to array of joints' bind matrices
    int unifTransMats; //handle to array of joints' overall transformation matrices
    int attrIndex; //handle to the indices of the two joints which influence the vertex
    int attrWeight; //handle to the weights of the two joints which influence the vertex
